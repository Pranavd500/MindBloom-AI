  ...
  try {
    const response = await client.chat.completions.create({
      ...
      messages: [
        {
          role: "system",
          content: "You are an empathetic AI wellness companion specialized in supporting students preparing for competitive exams. You provide structured, actionable wellness guidance. Always respond with valid JSON only, no markdown formatting."
        },
        {
          role: "user",
          content: prompt
